...
是不是 So So So easy？其实使用 React 写组件就是这么简单，当我们选择 Vue，Angular 这种基于模版的框架的时候，往往被模版约束。因此 Vue 也提供了这种对 JSX 的支持，而官方文档中也提到，在某些复杂交互场景下 JSX 具有比模版更灵活的优势。可见在组件开发这块 JSX 才是我们前端最终的归属。
    `,
  }
]